    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">Liste des Entreprises (<?php echo $nbrFiliere ?> Filières)</div>
                <div class="panel-body">
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th>Id Entreprise</th><th>Nom Entreprise</th><th>Niveau</th>
                                <?php if ($_SESSION['user']['role']== 'ADMIN') {?>
                                	<th>Actions</th>
                                <?php }?>
                            </tr>
                                    ...
                                    <td><?php echo $filiere['niveau'] ?> </td> 
                                     ...
                                     <?php if ($_SESSION['user']['role']== 'ADMIN') {?>
                                        <td>
                                            ...
                                            &nbsp;
                                            <a onclick="return confirm('Etes vous sur de vouloir supprimer l Entreprise')"
