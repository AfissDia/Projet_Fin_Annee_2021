    ...
    <body>
        ...
        <div class="container">
             ...
             <div class="panel panel-primary margetop60">
                <div class="panel-heading">Veuillez saisir les données de la nouvelle Entreprise</div>
                <div class="panel-body">
                    <form method="post" action="insertFiliere.php" class="form">
						
                        <div class="form-group">
                             <label for="niveau">Nom de l'Entreprise:</label>
                            <input type="text" name="nomF" 
                                   placeholder="Nom de la entreprise"
                                   class="form-control"/>
                        </div>
