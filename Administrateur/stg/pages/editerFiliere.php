...
<HTML>
    <head>
        <meta charset="utf-8">
        <title>Edition d'une Entreprise</title>
    ...
    <body>
        ...
        <div class="container">
             ...
             <div class="panel panel-primary margetop60">
                <div class="panel-heading">Edition Entreprise :</div>
                <div class="panel-body">
                    <form method="post" action="updateFiliere.php" class="form">
						<div class="form-group">
                             <label for="niveau">id Entreprise: <?php echo $idf ?></label>
                        ...
                        <div class="form-group">
                             <label for="niveau">Nom Entreprise:</label>
