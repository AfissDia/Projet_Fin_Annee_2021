    ...
    <fieldset class="fies">
            <legend class="legs">Véhicule A !</legend>
                ...
                <!-- formulaire nom prenom adresse et tel -->
                    ...
                    <br><br><br>
                    <label for="nom_assure_a" class="control-label col-sm-3"> Nom de l'Assuré</label>
                    <div class="col-sm-6">
                        <input type="text" name="nom_assure_a" id="nom_assurance" class="form-control">
                    </div>
                    <br><br><br>
                    <label for="prenom_assure_a" class="control-label col-sm-3"> Prenom de l'Assuré </label>
                    <div class="col-sm-6">
...
<fieldset class="fiesb">
    ...
    <label for="prenom" class="control-label col-sm-3"> Prenom </label>
                    ...
                    <br><br><br>
                    <label for="nom_assure" class="control-label col-sm-3"> Nom de l'Assuré o</label>
                    <div class="col-sm-6">
